...
const townData: Record<string, { label: string; values: number[] }> = {
  ...
  halifax: {
    label: 'Halifax',
    values: [
      330000,337000,343000,341000,342000,351000,358000,361000,
      364000,374000,393000,411000,427000,449000,467000,477000,
      485000,498000,505000,501000,503000,510000,517000,520000,
      524000,530000,537000,534000,532000,539000,545000,537000,
    ],
  },
  lakeville: {
    label: 'Lakeville',
    values: [
      345000,352000,359000,356000,358000,367000,374000,377000,
      380000,390000,410000,428000,445000,468000,486000,496000,
      504000,517000,524000,520000,522000,530000,537000,540000,
      544000,550000,557000,554000,552000,559000,565000,557000,
    ],
  },
  weston: {
    label: 'Weston',
    values: [
      920000,940000,958000,952000,957000,981000,998000,1005000,
      1014000,1040000,1092000,1140000,1183000,1244000,1293000,1321000,
      1338000,1372000,1387000,1378000,1383000,1400000,1415000,1423000,
      1432000,1447000,1462000,1454000,1450000,1468000,1482000,1461000,
    ],
  },
  kingston: {
    label: 'Kingston',
